        ...
        <div class="tab-content">
            <div class="active tab-pane active" id="detail">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" rows="6" cols="20" id="slogan" name="slogan" value="{{ $frontend->slogan }}" disabled> </input>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="course" name="course" value="{{ $frontend->course }}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content1_title" name="content1_title" value="{{ $frontend->content1_title }}" disabled>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content1_body" name="content1_body" rows="3" disabled> {{ $frontend->content1_body }}</textarea>
                    </div>
                </div>
                {{--  SECOND CONTENT  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content2_title" name="content2_title" value="{{ $frontend->content2_title }}" disabled>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content2_body" name="content2_body" rows="3" disabled> {{ $frontend->content2_body }} </textarea>
                    </div>
                </div>
                {{--  Third CONTENT  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content3_title" name="content3_title" value="{{ $frontend->content3_title }}" disabled>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content3_body" name="content3_body" rows="4" disabled>{{ $frontend->content3_body }}</textarea>
                    </div>
                </div>
                {{--  FIRST PROFILE  --}}
                <div class="form-group">
            ...
            <div class="tab-pane" id="edit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" rows="6" cols="20" id="slogan" name="slogan" value="{{ $frontend->slogan }}"> </input>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="students" name="students" value="{{ $frontend->students }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="educator" class="col-sm-3 control-label">Jumlah Pendidik</label>
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="educator" name="educator" value="{{ $frontend->educator }}">
                    </div>
                </div>
                {{--  Teacher Total  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="teacher" name="teacher" value="{{ $frontend->teacher }}">
                    </div>
                </div>
                {{--  Course Total  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="course" name="course" value="{{ $frontend->course }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content1_title" name="content1_title" value="{{ $frontend->content1_title }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="content1_body" class="col-sm-3 control-label">Isi Konten 1</label>
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content1_body" name="content1_body" rows="3">{{ $frontend->content1_body }}</textarea>
                    </div>
                </div>
                {{--  SECOND CONTENT  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content2_title" name="content2_title" value="{{ $frontend->content2_title }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="content2_body" class="col-sm-3 control-label">Isi Konten 2</label>
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content2_body" name="content2_body" rows="3">{{ $frontend->content2_body }}</textarea>
                    </div>
                </div>
                {{--  Third CONTENT  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content3_title" name="content3_title" value="{{ $frontend->content3_title }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="content3_body" name="content3_body" rows="3">{{ $frontend->content3_body }}</textarea>
                    </div>
                </div>
                {{--  FIRST PROFILE  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="profile1_title" name="profile1_title" value="{{ $frontend->profile1_title }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="profile1_body" class="col-sm-3 control-label">Isi Profil 1</label>
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="profile1_body" name="profile1_body" rows="3">{{ $frontend->profile1_body }}</textarea>
                    </div>
                </div>
                {{--  SECOND PROFILE  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="profile2_title" name="profile2_title" value="{{ $frontend->profile2_title }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="profile2_body" class="col-sm-3 control-label">Isi Profil 2</label>
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="profile2_body" name="profile2_body" rows="3">{{ $frontend->profile2_body }}</textarea>
                    </div>
                </div>
                {{--  THIRD PROFILE  --}}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="profile3_title" name="profile3_title" value="{{ $frontend->profile3_title }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="profile3_body" class="col-sm-3 control-label">Isi Profil 3</label>
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="profile3_body" name="profile3_body" rows="3">{{ $frontend->profile3_body }}</textarea>
                    </div>
                </div>
                <div class="form-group">
